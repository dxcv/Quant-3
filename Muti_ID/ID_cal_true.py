...
class ID_cal:
    ...
    def cal_rate_income(self):
        ...
        self.to_csv(filedata=d_rate_income, filename='ID_data/收益率_close_p.csv')
        ...
        an_file.to_csv('ID_data/年化收益率_复利.csv')
        ...
        self.to_csv(filedata=z_income_days, filename='ID_data/每股正收益天数.csv')
        self.to_csv(filedata=z_income_days_ratio, filename='ID_data/每股正收益天数比例.csv')
        self.to_csv(filedata=f_income_days, filename='ID_data/每股负收益天数.csv')
        self.to_csv(filedata=f_income_days_ratio, filename='ID_data/每股负收益天数比例.csv')
    ...
    def cal_mdd(self, d_rate_income):
        ...
        self.to_csv(filedata=MDD_all, filename='ID_data/每股的最大回撤.csv')
        return MDD_all
    ...
    def cal_beta_alpha(self, d_rate_income):
        ...
        beta = mat(beta).T
        self.to_csv(filedata=beta, filename='ID_data/beta.csv')
    ...
    def cal_sharpe(self, d_rate_income, annual_Vt, annual_rates):
        ...
        self.to_csv(filedata=Sharpe, filename='ID_data/Sharpe.csv')
        return Rf, Sharpe
    ...
    def cal_Information(self, annual_Vt, annual_rates):
        ...
        self.to_csv(filedata=IR, filename='ID_data/Information.csv')
    ...
    def cal_efficiency(self):
        ...
        self.to_csv(filedata=ER, filename='ID_data/Efficiency_Ratio.csv')
    ...
    def cal_Treynor_Calmar(self, Rf, annual_rates, beta, MDD_all):
        ...
        self.to_csv(filedata=Treynor, filename='ID_data/Treynor.csv')
        ...
        self.to_csv(filedata=Calmar, filename='ID_data/Calmar.csv')
    ...
    def cal_Sortino(self, d_rate_income, annual_rates, Rf):
        ...
        self.to_csv(filedata=Sortino, filename='ID_data/Sortino.csv')
    ...
    def cal_Skewness_Kurtosis(self):
        ...
        self.to_csv(filedata=S_k_all, filename='ID_data/Skewness.csv')
        self.to_csv(filedata=K_all, filename='ID_data/Kurtosis.csv')
    ...
    def cal_Tracking_Error(self, d_rate_income, SH300_d_rate, SH300_weight_por):
        ...
        annual_Tracking_Error = sqrt((252/row)*sum(diff_Rpa, axis=0))liaoliao
        self.to_csv(filedata=annual_Tracking_Error, filename='ID_data/annual_Tracking_Error.csv')
    ...
    def cal_PriceDensity(self):
        ...
        self.to_csv(filedata=PD, filename='ID_data/PriceDensity.csv')
    ...
    def cal_DIFF_FtoV(self, d_rate_income):
        ...
        self.to_csv(filedata=DIFF_FtoV, filename='ID_data/DIFF_FtoV.csv')
        return DIFF_FtoV

    def SH300_income(self):
        #计算基准组合的的日收益率
        data = open('HS300_收盘价.csv')
        ...
        self.to_csv(filedata=SH300_d_rate, filename='ID_data/HS300_收益率.csv')
        # 获取SH300的权重数据
    ...
    def sh_rate_income(self):
        ...
        self.to_csv(filedata=df_sh, filename='ID_data/上证指数的行情数据.csv')
        sh_row = len(sh_close)
